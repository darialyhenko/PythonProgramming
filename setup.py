...
with open('requiments/requiments.txt', 'r') as rf:
...
setuptools.setup(
	...
	version="0.0.1",
	# Имя автора.
	author="Daria Lykhenko",
	# Его почта.
	author_email="daria.lyhenko@gmail.com",
	...
	url="https://github.com/darialyhenko/PythonProgramming",
